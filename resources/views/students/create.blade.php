            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('students.store') }}">
                    @csrf <div class="mb-4">
                        ...
                        <input type="text" name="student_id" id="student_id" value="{{ old('student_id') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
