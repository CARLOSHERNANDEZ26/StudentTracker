            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('students.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="student_id" id="student_id" value="{{ old('student_id') }}" maxlength="9" required placeholder="e.g. 202300123" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="middle_name" id="middle_name" value="{{ old('middle_name') }}" placeholder="(Optional)" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            @error('middle_name') <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p> @enderror
                        </div>
                    </div>

                    <div class="mb-6">
                        <label for="section" class="block text-gray-700 text-sm font-bold mb-2">Section</label>
                        <input type="text" name="section" id="section" value="{{ old('section') }}" required placeholder="e.g., BSIT 3-A" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
